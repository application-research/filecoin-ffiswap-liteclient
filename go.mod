module github.com/application-research/filecoin-ffiswap-liteclient

go 1.17

require (
	github.com/filecoin-project/filecoin-ffi/cgo v0.0.0-00010101000000-000000000000
...
replace github.com/filecoin-project/filecoin-ffi/cgo => ./cgo
